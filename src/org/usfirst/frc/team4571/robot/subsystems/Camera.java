...
public class Camera extends Subsystem {
    ...
    public void initDefaultCommand() {
        ...
        //setDefaultCommand(new YellowToteAuto());
    }
    public class ParticleReport implements Comparator<ParticleReport>, Comparable<ParticleReport>{
		...
		public int compare(ParticleReport r1, ParticleReport r2)
		{
			...
			public Camera() {
				...
				criteria[0] = new NIVision.ParticleFilterCriteria2(NIVision.MeasurementType.MT_AREA_BY_IMAGE_AREA, RobotMap.AREA_MINIMUM, 100.0, 0, 0);

				// open the camera at the IP address assigned. This is the IP address that the camera
		        // can be accessed through the web interface.
		        camera = new AxisCamera("10.45.71.20");
				...
				SmartDashboard.putNumber("Area min %", RobotMap.AREA_MINIMUM);*/
